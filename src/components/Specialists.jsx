...
const Specialists = () => {
    const specialists =[
        {
             ...
             bio:'Skilled in surgical procedures to enhance appearance natural body contours.',
             rating: 5,
        ...
        },
        {
             ...
             bio:'Expert in skin health, providing treatments for radiant, healthy, and clear skin.',
             rating: 4,
        ...
        },
        {
             ...
             bio:'Specialist in non-surgical treatments to enhance natural beauty safely.',
             rating: 5,
  ...
  return (
         <section id='specialists' className='py-20 overflow-hidden bg-gradiant-to-rfrom-pink-100 tp-purple-100'>
           <div className='container mx-auto px-4'>
             <header data-aos='fade-up' data-aos-delay='400' className='text-center mb-16 relative'>
             <span className='absolute-top-10 left-1/3 transform -translate-x-1/2 w-20 h-20 rounded-fullbg-pink-100 opacity-30 z-0' aria-hidden='true'></span>
             <h2 className='text-3x1 md:text-4x1 font-bold text-gray-800 mb-4 relative z-10'>Meet Our <span className='text-pink-600'>Expert Team</span>
           </h2>
        <p className='text-lgtext-gray-600 max-w-2x1 mx-auto relative z-10'> Skilled specialists delivering safe, personalized care to enhance your natural beauty.
        </p>
        <span className='absolute -bottom-6 right-1/4 w-16 h-16 rounded-fullbg-purple-100 opacity-20 z-0' aria-hidden='true'></span>
       </header>
       ...
       <ul data-aos='fade-up' data-aos-delay='500' className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>
       {
        specialists.map((doctor) => (
          ...
          <article className='bg-white rounded-x1 shadow-lg overflow-hidden hover: shadow-x1 transition-all duration-300 h-full'>
           ...
           <img
              src={doctor.image}
               className='w-full h-full object-cover transition-transform duration-500
                ...
                loading='lazy' />
            <span className='absolute inset-0 bg-linear-to-t from-black/60
...
<aside data-aos='fade-up' data-aos-delay='500' className='bg-linear-to-r from-pink-100 to-purple-100 rounded-2x1 p-8 md:p-12 text-center relative overflow-hidden'>
...
<p className='text-lg text-gray-600 mb-8 max-w-2x1 mx-auto'>
 Book your consultation today and start your journey to a confident, radiant you.
</p>
...
aria-label='Book a consultation'>Book a consultation
</a>
<a
href='#'
className='border
border-pink-600
hover:bg-pink-50
text-pink-600 px-8 py-3 rounded-full
transition focus:outline-none focus:ring-2 focus: ring-pink-500 focus: ring-offset-2'
