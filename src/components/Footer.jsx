  import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaYoutube, FaClinicMedical,} from 'react-icons/fa';
...
const Footer = () => {
  ...
  const contactInfo = [
    {
      icon: <MdLocationOn className="text-pink-500 text-xl mt-1 mr-4 shrink-0" />,
      content: (
        <a href="#" className="text-gray-400 hover:text-pink-500 transition">
          123 Beauty Avenue, Medical Road, Colombo.
        </a>
      ),
    },
    {
      ...
      content: (
        <a href="tel:+44112345678" className="text-gray-400 hover:text-pink-500 transition">
          +94 11 234 5678
        </a>
      ),
    },
    {
      ...
      content: (
        <a href="mailto:info@glamclin.com" className="text-gray-400 hover:text-pink-500 transition">
          info@glamclin.com
        </a>
      ),
    },
    {
      icon: <MdAccessTime className="text-pink-500 text-xl mt-1 mr-4 shrink-0" />,
      content: (
        <span className="text-gray-400">Sun–Thu: 9AM–8PM, Fri: 2PM–9PM</span>
      ),
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <section className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6">
              At Glamour Clinic, we combine advanced aesthetic treatments with personalized care to help you look and feel your best.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Glamour Clinic. All rights reserved.
          </p>
